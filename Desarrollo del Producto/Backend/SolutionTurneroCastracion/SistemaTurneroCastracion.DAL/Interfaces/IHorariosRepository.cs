...
namespace SistemaTurneroCastracion.DAL.Interfaces
{
    public interface IHorariosRepository : IGenericRepository<Horarios>
    {
        ...
        Task<bool> CancelarTurno(CancelacionRequestDTO request, HttpContext httpContext);
        ...
        Task<List<HorariosCanceladosResponse>> ObtenerCanceladosPorCentro(TurnosSecretariaDTO filtro);
