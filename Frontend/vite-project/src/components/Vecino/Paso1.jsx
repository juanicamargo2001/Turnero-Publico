...
const Paso1Visual = ({ formData, updateFormData, nextStep }) => {
  ...
  const handleScanData = (e) => {
    if (scanResult === "") {
      Swal.fire({
        text: "Sucedió un error al leer el codigo",
        icon: "error",
        confirmButtonColor: "#E15562",
        confirmButtonText: "OK",
      }).then(() => {});
  ...
  const handleDomicilioFoto = async () => {
    if (selectedFile2 === null) {
      ...
      setIsLoading(true);
      const response = await vecinoService.uploadImage(
        selectedFile2,
        formularioRelleno.dni
      );
      if (response) {
        setIsLoading(false);
        Swal.fire({
    ...
    <div>
      ...
      {showOtherOption && (
        <div>
          ...
          <label htmlFor="docPrimerPic" className="form-label">
          ...
          <div className="d-flex justify-content-end p-2">
            <button
              type="button"
              className="btn btn-secondary me-2 confir2"
            ...
            <button
              type="submit"
              className="btn btn-success  confir"
        ...
        <div className="containerPaso1">
          ...
          >
            <div className="mb-3">
              ...
              <input
                ...
                {...register("dni", {
                  ...
                  validate: (value) =>
                    value > 0 || "El DNI debe ser mayor que 0",
                })}
            ...
            <div className="mb-3">
              ...
              />
              {errors.fNacimiento && (
                <p style={{ color: "red" }}>{errors.fNacimiento.message}</p>
              )}
            </div>
            ...
            <div className="d-flex mt-3">
              <button
                ...
                onClick={handleOtherOptionClick2}
              >
                <span
                  style={{
                    fontSize: "1rem",
                    "@media (max-width: 768px)": { fontSize: "0.95rem" },
                  }}
                  className="me-1"
                >
                  Verificar domicilio con DNI
                </span>
              </button>
            </div>
            <div className="mb-3">
              ...
              {errors.domicilio && (
                <p style={{ color: "red" }}>{errors.domicilio.message}</p>
              )}
            </div>
      ...
      {showOtherOption2 && (
        <div>
          <label htmlFor="docSegundaPic" className="form-label">
            Sube una foto del DORSO del documento
          </label>
          <div className="upload-container mb-3">
            {selectedFile2 ? (
              <div className="mb-3">
