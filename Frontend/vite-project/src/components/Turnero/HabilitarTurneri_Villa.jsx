...
const HabilitarTurneroVilla = () => {
  ...
  return (
    <div className="container maven-pro-body">
      <h3 className="maven-pro-title p-4">Habilitar Turnero VILLA ALLLENDE</h3>
              ...
              <Row className="mb-3" key={index}>
                <Col sm={3}>
                  <Form.Group>
                    ...
                    <Form.Control 
                      type="time" 
                      value={shift.horaInicio.split(':').slice(0, 2).join(':')}
...
export default HabilitarTurneroVilla;
